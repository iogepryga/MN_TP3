...
#pragma omp parallel for
  for (register unsigned int i = 0 ; i < max ; i++) {
    ((complexe_float_t*)Y+i*diff)->real += ((complexe_float_t*)alpha)->real * ((complexe_float_t*)X+i)->real - ((complexe_float_t*)alpha)->imaginary * ((complexe_float_t*)X+i)->imaginary;
    ((complexe_float_t*)Y+i*diff)->imaginary += ((complexe_float_t*)alpha)->imaginary * ((complexe_float_t*)X+i)->real + ((complexe_float_t*)alpha)->real * ((complexe_float_t*)X+i)->imaginary;
...
#pragma omp parallel for
  for (register unsigned int i = 0 ; i < max ; i++) {
    ((complexe_double_t*)Y+i*diff)->real += ((complexe_double_t*)alpha)->real * ((complexe_double_t*)X+i)->real - ((complexe_double_t*)alpha)->imaginary * ((complexe_double_t*)X+i)->imaginary;
    ((complexe_double_t*)Y+i*diff)->imaginary += ((complexe_double_t*)alpha)->imaginary * ((complexe_double_t*)X+i)->real + ((complexe_double_t*)alpha)->real * ((complexe_double_t*)X+i)->imaginary;
